...
class NativeLibrary {
  ...
  /// to operate as usual.
  ffi.Pointer<rd_kafka_mock_cluster_t> rd_kafka_mock_cluster_new(
    ffi.Pointer<rd_kafka_t> rk,
    int broker_cnt,
  ) {
    return _rd_kafka_mock_cluster_new(
      rk,
      broker_cnt,
    );
  }

  late final _rd_kafka_mock_cluster_newPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<rd_kafka_mock_cluster_t> Function(
              ffi.Pointer<rd_kafka_t>, ffi.Int)>>('rd_kafka_mock_cluster_new');
  late final _rd_kafka_mock_cluster_new =
      _rd_kafka_mock_cluster_newPtr.asFunction<
          ffi.Pointer<rd_kafka_mock_cluster_t> Function(
              ffi.Pointer<rd_kafka_t>, int)>();

  /// @brief Destroy mock cluster.
  void rd_kafka_mock_cluster_destroy(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
  ) {
    return _rd_kafka_mock_cluster_destroy(
      mcluster,
    );
  }

  late final _rd_kafka_mock_cluster_destroyPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<rd_kafka_mock_cluster_t>)>>(
      'rd_kafka_mock_cluster_destroy');
  late final _rd_kafka_mock_cluster_destroy = _rd_kafka_mock_cluster_destroyPtr
      .asFunction<void Function(ffi.Pointer<rd_kafka_mock_cluster_t>)>();

  /// @returns the rd_kafka_t instance for a cluster as passed to
  /// rd_kafka_mock_cluster_new().
  ffi.Pointer<rd_kafka_t> rd_kafka_mock_cluster_handle(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
  ) {
    return _rd_kafka_mock_cluster_handle(
      mcluster,
    );
  }

  late final _rd_kafka_mock_cluster_handlePtr = _lookup<
          ffi.NativeFunction<
              ffi.Pointer<rd_kafka_t> Function(
                  ffi.Pointer<rd_kafka_mock_cluster_t>)>>(
      'rd_kafka_mock_cluster_handle');
  late final _rd_kafka_mock_cluster_handle =
      _rd_kafka_mock_cluster_handlePtr.asFunction<
          ffi.Pointer<rd_kafka_t> Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>)>();
  ...
  ffi.Pointer<rd_kafka_mock_cluster_t> rd_kafka_handle_mock_cluster(
    ffi.Pointer<rd_kafka_t> rk,
  ) {
    return _rd_kafka_handle_mock_cluster(
      rk,
    );
  }

  late final _rd_kafka_handle_mock_clusterPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<rd_kafka_mock_cluster_t> Function(
              ffi.Pointer<rd_kafka_t>)>>('rd_kafka_handle_mock_cluster');
  late final _rd_kafka_handle_mock_cluster =
      _rd_kafka_handle_mock_clusterPtr.asFunction<
          ffi.Pointer<rd_kafka_mock_cluster_t> Function(
              ffi.Pointer<rd_kafka_t>)>();

  /// @returns the mock cluster's bootstrap.servers list
  ffi.Pointer<ffi.Char> rd_kafka_mock_cluster_bootstraps(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
  ) {
    return _rd_kafka_mock_cluster_bootstraps(
      mcluster,
    );
  }

  late final _rd_kafka_mock_cluster_bootstrapsPtr = _lookup<
          ffi.NativeFunction<
              ffi.Pointer<ffi.Char> Function(
                  ffi.Pointer<rd_kafka_mock_cluster_t>)>>(
      'rd_kafka_mock_cluster_bootstraps');
  late final _rd_kafka_mock_cluster_bootstraps =
      _rd_kafka_mock_cluster_bootstrapsPtr.asFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>)>();

  /// @brief Clear the cluster's error state for the given \p ApiKey.
  void rd_kafka_mock_clear_request_errors(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    int ApiKey,
  ) {
    return _rd_kafka_mock_clear_request_errors(
      mcluster,
      ApiKey,
    );
  }

  late final _rd_kafka_mock_clear_request_errorsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Int16)>>('rd_kafka_mock_clear_request_errors');
  late final _rd_kafka_mock_clear_request_errors =
      _rd_kafka_mock_clear_request_errorsPtr.asFunction<
          void Function(ffi.Pointer<rd_kafka_mock_cluster_t>, int)>();
  ...
  /// requests.
  void rd_kafka_mock_push_request_errors(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    int ApiKey,
    int cnt,
  ) {
    return _rd_kafka_mock_push_request_errors(
      mcluster,
      ApiKey,
      cnt,
    );
  ...
  late final _rd_kafka_mock_push_request_errorsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<rd_kafka_mock_cluster_t>, ffi.Int16,
              ffi.Size)>>('rd_kafka_mock_push_request_errors');
  late final _rd_kafka_mock_push_request_errors =
      _rd_kafka_mock_push_request_errorsPtr.asFunction<
          void Function(ffi.Pointer<rd_kafka_mock_cluster_t>, int, int)>();
  ...
  void rd_kafka_mock_push_request_errors_array(
    ...
    int ApiKey,
    int cnt,
    ffi.Pointer<ffi.Int> errors,
  ) {
    return _rd_kafka_mock_push_request_errors_array(
      mcluster,
      ApiKey,
      cnt,
      errors,
  ...
  late final _rd_kafka_mock_push_request_errors_arrayPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<rd_kafka_mock_cluster_t>, ffi.Int16,
                  ffi.Size, ffi.Pointer<ffi.Int>)>>(
      'rd_kafka_mock_push_request_errors_array');
  late final _rd_kafka_mock_push_request_errors_array =
      _rd_kafka_mock_push_request_errors_arrayPtr.asFunction<
          void Function(ffi.Pointer<rd_kafka_mock_cluster_t>, int, int,
              ffi.Pointer<ffi.Int>)>();
  ...
  rd_kafka_resp_err_t rd_kafka_mock_broker_push_request_error_rtts(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    int broker_id,
    int ApiKey,
    int cnt,
    ...
    return rd_kafka_resp_err_t
        .fromValue(_rd_kafka_mock_broker_push_request_error_rtts(
      mcluster,
      broker_id,
      ApiKey,
      cnt,
  ...
  late final _rd_kafka_mock_broker_push_request_error_rttsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Int32,
              ffi.Int16,
              ffi.Size)>>('rd_kafka_mock_broker_push_request_error_rtts');
  late final _rd_kafka_mock_broker_push_request_error_rtts =
      _rd_kafka_mock_broker_push_request_error_rttsPtr.asFunction<
          int Function(ffi.Pointer<rd_kafka_mock_cluster_t>, int, int, int)>();
  ...
  rd_kafka_resp_err_t rd_kafka_mock_broker_error_stack_cnt(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    int broker_id,
    int ApiKey,
    ffi.Pointer<ffi.Size> cntp,
  ) {
    return rd_kafka_resp_err_t.fromValue(_rd_kafka_mock_broker_error_stack_cnt(
      mcluster,
      broker_id,
      ApiKey,
      cntp,
  ...
  late final _rd_kafka_mock_broker_error_stack_cntPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Int32,
              ffi.Int16,
              ffi.Pointer<ffi.Size>)>>('rd_kafka_mock_broker_error_stack_cnt');
  late final _rd_kafka_mock_broker_error_stack_cnt =
      _rd_kafka_mock_broker_error_stack_cntPtr.asFunction<
          int Function(ffi.Pointer<rd_kafka_mock_cluster_t>, int, int,
              ffi.Pointer<ffi.Size>)>();
  ...
  void rd_kafka_mock_topic_set_error(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    ffi.Pointer<ffi.Char> topic,
    rd_kafka_resp_err_t err,
  ) {
    return _rd_kafka_mock_topic_set_error(
      mcluster,
      topic,
      err.value,
    );
  ...
  late final _rd_kafka_mock_topic_set_errorPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Char>,
              ffi.Int)>>('rd_kafka_mock_topic_set_error');
  late final _rd_kafka_mock_topic_set_error =
      _rd_kafka_mock_topic_set_errorPtr.asFunction<
          void Function(ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Char>, int)>();
  ...
  /// mock broker.
  rd_kafka_resp_err_t rd_kafka_mock_topic_create(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    ffi.Pointer<ffi.Char> topic,
    int partition_cnt,
    int replication_factor,
  ) {
    return rd_kafka_resp_err_t.fromValue(_rd_kafka_mock_topic_create(
      mcluster,
      topic,
      partition_cnt,
      replication_factor,
  ...
  late final _rd_kafka_mock_topic_createPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Char>,
              ffi.Int,
              ffi.Int)>>('rd_kafka_mock_topic_create');
  late final _rd_kafka_mock_topic_create =
      _rd_kafka_mock_topic_createPtr.asFunction<
          int Function(ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Char>, int, int)>();
  ...
  rd_kafka_resp_err_t rd_kafka_mock_partition_set_leader(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    ffi.Pointer<ffi.Char> topic,
    int partition,
    int broker_id,
  ) {
    return rd_kafka_resp_err_t.fromValue(_rd_kafka_mock_partition_set_leader(
      mcluster,
      topic,
      partition,
      broker_id,
  ...
  late final _rd_kafka_mock_partition_set_leaderPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Char>,
              ffi.Int32,
              ffi.Int32)>>('rd_kafka_mock_partition_set_leader');
  late final _rd_kafka_mock_partition_set_leader =
      _rd_kafka_mock_partition_set_leaderPtr.asFunction<
          int Function(ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Char>, int, int)>();
  ...
  rd_kafka_resp_err_t rd_kafka_mock_partition_set_follower(
    ...
    return rd_kafka_resp_err_t.fromValue(_rd_kafka_mock_partition_set_follower(
      mcluster,
      topic,
      partition,
      broker_id,
  ...
  late final _rd_kafka_mock_partition_set_followerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Char>,
              ffi.Int32,
              ffi.Int32)>>('rd_kafka_mock_partition_set_follower');
  late final _rd_kafka_mock_partition_set_follower =
      _rd_kafka_mock_partition_set_followerPtr.asFunction<
          int Function(ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Char>, int, int)>();
  ...
  rd_kafka_resp_err_t rd_kafka_mock_partition_set_follower_wmarks(
    ...
    return rd_kafka_resp_err_t
        .fromValue(_rd_kafka_mock_partition_set_follower_wmarks(
      mcluster,
      topic,
      partition,
      lo,
  ...
  late final _rd_kafka_mock_partition_set_follower_wmarksPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Char>,
              ffi.Int32,
              ffi.Int64,
              ffi.Int64)>>('rd_kafka_mock_partition_set_follower_wmarks');
  late final _rd_kafka_mock_partition_set_follower_wmarks =
      _rd_kafka_mock_partition_set_follower_wmarksPtr.asFunction<
          int Function(ffi.Pointer<rd_kafka_mock_cluster_t>,
  ...
  rd_kafka_resp_err_t rd_kafka_mock_broker_set_down(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    int broker_id,
  ) {
    return rd_kafka_resp_err_t.fromValue(_rd_kafka_mock_broker_set_down(
      mcluster,
      broker_id,
    ));
  }

  late final _rd_kafka_mock_broker_set_downPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Int32)>>('rd_kafka_mock_broker_set_down');
  late final _rd_kafka_mock_broker_set_down = _rd_kafka_mock_broker_set_downPtr
      .asFunction<int Function(ffi.Pointer<rd_kafka_mock_cluster_t>, int)>();
  ...
  rd_kafka_resp_err_t rd_kafka_mock_broker_set_up(
    ...
    return rd_kafka_resp_err_t.fromValue(_rd_kafka_mock_broker_set_up(
      mcluster,
      broker_id,
    ));
  }

  late final _rd_kafka_mock_broker_set_upPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Int32)>>('rd_kafka_mock_broker_set_up');
  late final _rd_kafka_mock_broker_set_up = _rd_kafka_mock_broker_set_upPtr
      .asFunction<int Function(ffi.Pointer<rd_kafka_mock_cluster_t>, int)>();
  ...
  /// @param mcluster Mock cluster instance.
  /// @param broker_id Use -1 for all brokers, or >= 0 for a specific broker.
  rd_kafka_resp_err_t rd_kafka_mock_broker_set_rtt(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    int broker_id,
    int rtt_ms,
  ) {
    return rd_kafka_resp_err_t.fromValue(_rd_kafka_mock_broker_set_rtt(
      mcluster,
      broker_id,
      rtt_ms,
    ));
  ...
  late final _rd_kafka_mock_broker_set_rttPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<rd_kafka_mock_cluster_t>, ffi.Int32,
              ffi.Int)>>('rd_kafka_mock_broker_set_rtt');
  late final _rd_kafka_mock_broker_set_rtt =
      _rd_kafka_mock_broker_set_rttPtr.asFunction<
          int Function(ffi.Pointer<rd_kafka_mock_cluster_t>, int, int)>();
  ...
  /// @param mcluster Mock cluster instance.
  /// @param broker_id Use -1 for all brokers, or >= 0 for a specific broker.
  rd_kafka_resp_err_t rd_kafka_mock_broker_set_rack(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    int broker_id,
    ffi.Pointer<ffi.Char> rack,
  ) {
    return rd_kafka_resp_err_t.fromValue(_rd_kafka_mock_broker_set_rack(
      mcluster,
      broker_id,
      rack,
    ));
  ...
  late final _rd_kafka_mock_broker_set_rackPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<rd_kafka_mock_cluster_t>, ffi.Int32,
              ffi.Pointer<ffi.Char>)>>('rd_kafka_mock_broker_set_rack');
  late final _rd_kafka_mock_broker_set_rack =
      _rd_kafka_mock_broker_set_rackPtr.asFunction<
          int Function(ffi.Pointer<rd_kafka_mock_cluster_t>, int,
              ffi.Pointer<ffi.Char>)>();
  ...
  rd_kafka_resp_err_t rd_kafka_mock_coordinator_set(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    ffi.Pointer<ffi.Char> key_type,
    ffi.Pointer<ffi.Char> key,
    int broker_id,
  ) {
    return rd_kafka_resp_err_t.fromValue(_rd_kafka_mock_coordinator_set(
      mcluster,
      key_type,
      key,
      broker_id,
  ...
  late final _rd_kafka_mock_coordinator_setPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>,
              ffi.Int32)>>('rd_kafka_mock_coordinator_set');
  late final _rd_kafka_mock_coordinator_set =
      _rd_kafka_mock_coordinator_setPtr.asFunction<
          int Function(ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>, int)>();
  ...
  rd_kafka_resp_err_t rd_kafka_mock_set_apiversion(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    int ApiKey,
    int MinVersion,
    int MaxVersion,
  ) {
    return rd_kafka_resp_err_t.fromValue(_rd_kafka_mock_set_apiversion(
      mcluster,
      ApiKey,
      MinVersion,
      MaxVersion,
  ...
  late final _rd_kafka_mock_set_apiversionPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<rd_kafka_mock_cluster_t>, ffi.Int16,
              ffi.Int16, ffi.Int16)>>('rd_kafka_mock_set_apiversion');
  late final _rd_kafka_mock_set_apiversion =
      _rd_kafka_mock_set_apiversionPtr.asFunction<
          int Function(ffi.Pointer<rd_kafka_mock_cluster_t>, int, int, int)>();

  /// @brief Start tracking RPC requests for this mock cluster.
  /// @sa rd_kafka_mock_get_requests to get the requests.
  void rd_kafka_mock_start_request_tracking(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
  ) {
    return _rd_kafka_mock_start_request_tracking(
      mcluster,
    );
  }

  late final _rd_kafka_mock_start_request_trackingPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<rd_kafka_mock_cluster_t>)>>(
      'rd_kafka_mock_start_request_tracking');
  late final _rd_kafka_mock_start_request_tracking =
      _rd_kafka_mock_start_request_trackingPtr
          .asFunction<void Function(ffi.Pointer<rd_kafka_mock_cluster_t>)>();

  /// @brief Stop tracking RPC requests for this mock cluster.
  /// Does not clear already tracked requests.
  void rd_kafka_mock_stop_request_tracking(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
  ) {
    return _rd_kafka_mock_stop_request_tracking(
      mcluster,
    );
  }

  late final _rd_kafka_mock_stop_request_trackingPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<rd_kafka_mock_cluster_t>)>>(
      'rd_kafka_mock_stop_request_tracking');
  late final _rd_kafka_mock_stop_request_tracking =
      _rd_kafka_mock_stop_request_trackingPtr
          .asFunction<void Function(ffi.Pointer<rd_kafka_mock_cluster_t>)>();

  /// @brief Destroy a rd_kafka_mock_request_t * and deallocate memory.
  void rd_kafka_mock_request_destroy(
    ffi.Pointer<rd_kafka_mock_request_t> mreq,
  ) {
    return _rd_kafka_mock_request_destroy(
      mreq,
    );
  }

  late final _rd_kafka_mock_request_destroyPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<rd_kafka_mock_request_t>)>>(
      'rd_kafka_mock_request_destroy');
  late final _rd_kafka_mock_request_destroy = _rd_kafka_mock_request_destroyPtr
      .asFunction<void Function(ffi.Pointer<rd_kafka_mock_request_t>)>();

  /// @brief Get the broker id to which \p mreq was sent.
  int rd_kafka_mock_request_id(
    ffi.Pointer<rd_kafka_mock_request_t> mreq,
  ) {
    return _rd_kafka_mock_request_id(
      mreq,
    );
  }

  late final _rd_kafka_mock_request_idPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int32 Function(ffi.Pointer<rd_kafka_mock_request_t>)>>(
      'rd_kafka_mock_request_id');
  late final _rd_kafka_mock_request_id = _rd_kafka_mock_request_idPtr
      .asFunction<int Function(ffi.Pointer<rd_kafka_mock_request_t>)>();

  /// @brief Get the ApiKey with which \p mreq was sent.
  int rd_kafka_mock_request_api_key(
    ffi.Pointer<rd_kafka_mock_request_t> mreq,
  ) {
    return _rd_kafka_mock_request_api_key(
      mreq,
    );
  }

  late final _rd_kafka_mock_request_api_keyPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int16 Function(ffi.Pointer<rd_kafka_mock_request_t>)>>(
      'rd_kafka_mock_request_api_key');
  late final _rd_kafka_mock_request_api_key = _rd_kafka_mock_request_api_keyPtr
      .asFunction<int Function(ffi.Pointer<rd_kafka_mock_request_t>)>();

  /// @brief Get the timestamp in micros at which \p mreq was sent.
  int rd_kafka_mock_request_timestamp(
    ffi.Pointer<rd_kafka_mock_request_t> mreq,
  ) {
    return _rd_kafka_mock_request_timestamp(
      mreq,
    );
  }

  late final _rd_kafka_mock_request_timestampPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int64 Function(ffi.Pointer<rd_kafka_mock_request_t>)>>(
      'rd_kafka_mock_request_timestamp');
  late final _rd_kafka_mock_request_timestamp =
      _rd_kafka_mock_request_timestampPtr
          .asFunction<int Function(ffi.Pointer<rd_kafka_mock_request_t>)>();
  ...
  ffi.Pointer<ffi.Pointer<rd_kafka_mock_request_t>> rd_kafka_mock_get_requests(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
    ffi.Pointer<ffi.Size> cntp,
  ) {
    return _rd_kafka_mock_get_requests(
      mcluster,
      cntp,
    );
  }

  late final _rd_kafka_mock_get_requestsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Pointer<rd_kafka_mock_request_t>> Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>,
              ffi.Pointer<ffi.Size>)>>('rd_kafka_mock_get_requests');
  late final _rd_kafka_mock_get_requests =
      _rd_kafka_mock_get_requestsPtr.asFunction<
          ffi.Pointer<ffi.Pointer<rd_kafka_mock_request_t>> Function(
              ffi.Pointer<rd_kafka_mock_cluster_t>, ffi.Pointer<ffi.Size>)>();

  /// @brief Clear the list of requests sent to this mock broker, in case request
  /// tracking is/was turned on.
  void rd_kafka_mock_clear_requests(
    ffi.Pointer<rd_kafka_mock_cluster_t> mcluster,
  ) {
    return _rd_kafka_mock_clear_requests(
      mcluster,
    );
  }

  late final _rd_kafka_mock_clear_requestsPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<rd_kafka_mock_cluster_t>)>>(
      'rd_kafka_mock_clear_requests');
  late final _rd_kafka_mock_clear_requests = _rd_kafka_mock_clear_requestsPtr
      .asFunction<void Function(ffi.Pointer<rd_kafka_mock_cluster_t>)>();
}
...
final class rd_kafka_mock_cluster_s extends ffi.Opaque {}
...
///
/// @{
typedef rd_kafka_mock_cluster_t = rd_kafka_mock_cluster_s;

final class rd_kafka_mock_request_s extends ffi.Opaque {}

/// @name Represents a request to the mock cluster along with a timestamp.
typedef rd_kafka_mock_request_t = rd_kafka_mock_request_s;
...
const int RD_KAFKA_VERSION = 33751295;
